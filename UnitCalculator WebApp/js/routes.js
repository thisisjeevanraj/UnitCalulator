var routes = [
  ...
  {
    path: '/createproject/',
    url: './mypages/createproject.html',
    name: 'createproject',
  },
    // manage project
  {
    path: '/manageproject/',
    url: './mypages/manageproject.html',
    name: 'manageproject',
  },
     // project detail
  {
    path: '/projectdetail/',
    url: './mypages/projectdetail.html',
    name: 'projectdetail',
  },
    // manager task review
  {
    path: '/managertaskreview/',
    url: './mypages/managertaskreview.html',
    name: 'managertaskreview',
  },
    // create task
  {
    path: '/createtask/',
    url: './mypages/createtask.html',
    name: 'createtask',
  },
    // manage task
  {
    path: '/managetask/',
    url: './mypages/managetask.html',
    name: 'managetask',
  },
    // task detail
  {
    path: '/taskdetail/',
    url: './mypages/taskdetail.html',
    name: 'taskdetail',
  },
  // Right Panel pages
  {
